		...
		<div class="row">
			...
			<div class="col-md-2 col-sm-3 col-xs-6 pull-right">
				...
				<ul id='top-menu' class='dropdown-content top-menu-sty'>
					<li><a href="{{URL::to('/physic/profile')}}" class="waves-effect"><i class="fa fa-cogs"></i>Profile</a> </li>					
					<li>
			...
			<div class="sb2-1">
				...
				<div class="sb2-13">
					<ul class="collapsible" data-collapsible="accordion">
						<li><a href="{{URL::to('/physic/list')}}" class="menu-active"><i class="fa fa-users" aria-hidden="true"></i> Patient Records </a> </li>
						<li><a href="{{URL::to('/physic/edit')}}" class="menu-active"><i class="fa fa-user" aria-hidden="true"></i> Profile </a> </li>				
				</div>
			</div>
