...
@section('content')
    <h4>{{$physic->first_name}} {{$physic->last_name}}</h4> 
    <!-- Dropdown Structure -->
    <div class="split-row">
        <div class="col-md-12">
                        ...
                        <div class="">
                            ...
                            {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        <input id="email" name="email" type="text" class="validate" value="@isset($physic){{$physic->email}}@endisset" required readonly>
        ...
        $("#save_btn").click(function(event){
            ...
            .then((value) => {
                switch (value) {                
                    case "Save":
                        if(bSave()){
                            $("#physic_save_form").attr('action',"{{URL::to('physic/edit')}}");
