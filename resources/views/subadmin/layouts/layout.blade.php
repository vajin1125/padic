		...
		<div class="row">
			...
			<div class="col-md-2 col-sm-3 col-xs-6 pull-right">
				...
				<ul id='top-menu' class='dropdown-content top-menu-sty'>
					<li><a href="{{URL::to('/subadmin/profile')}}" class="waves-effect"><i class="fa fa-cogs"></i>Profile</a> </li>					
					<li>
			...
			<div class="sb2-1">
				...
				<div class="sb2-13">
					<ul class="" data-collapsible="">
						<li><a href="{{URL::to('/subadmin/admin_list')}}" class="menu-active">
							<i class="fa fa-users" aria-hidden="true"></i> Admin Users</a> 
						</li>
						<li><a href="{{URL::to('/subadmin/physic_search')}}" class="menu-active">
							<i class="fa fa-binoculars" aria-hidden="true"></i> Search Physician</a> 
						</li>
						<li><a href="{{URL::to('/subadmin/physic_all')}}" class="menu-active">
							<i class="fa fa-group" aria-hidden="true"></i> All Physicians</a> 
						</li>
						<li><a href="{{URL::to('/subadmin/patient_search')}}" class="menu-active">
							<i class="fa fa-binoculars" aria-hidden="true"></i> Search Patient</a> 
						</li>
						<li><a href="{{URL::to('/subadmin/patient_all')}}" class="menu-active">
							<i class="fa fa-group" aria-hidden="true"></i> All Patients</a> 
						</li>	
						<li><a href="{{URL::to('/subadmin/profile')}}" class="menu-active">
